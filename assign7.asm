...
title_len: equ $-title
openmsg: db 10,"File Opened Successfully",0x0A
openmsg_len: equ $-openmsg
closemsg: db 10,"File Closed Successfully",0x0A
closemsg_len: equ $-closemsg
errormsg: db 10,"Failed to open file", 0x0A
errormsg_len: equ $-errormsg
sortmsg: db 10,"After Sorting "
